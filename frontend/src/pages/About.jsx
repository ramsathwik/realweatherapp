      ...
      <section className="relative bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-20">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-lg md:text-xl mb-6">
            Check if it’s going to be very hot, cold, windy, wet, or
            uncomfortable at your chosen location and time.
          </p>
          <div className="relative">
            <img
              src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e"
              alt="Outdoor banner"
              className="mx-auto rounded-2xl shadow-lg w-full md:w-3/4 lg:w-2/3"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-black/20 to-transparent rounded-2xl flex flex-col justify-center items-center">
              <Link
                to="/weather"
                className="bg-white text-indigo-600 px-6 py-3 mt-6 rounded-2xl shadow-md hover:scale-105 transition"
              >
                Explore Weather
              </Link>
            </div>
